...
// ...not these
var c = document.getElementById("blurred"),
	ctx = c.getContext("2d"),
...
const configObserver = { subtree: true, characterData: true, childList: true };
let lastHeight = null
...
observerContainer.observe(container, configObserver);
...
bg.src = './src/imgs/backgroundImg.jpg';
img.src = './src/imgs/blurLight1.png';
img2.src = './src/imgs/blurLight2.png';
img3.src = './src/imgs/blurLight3.png';